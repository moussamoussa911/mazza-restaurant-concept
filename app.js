...
const copy = {
  ...
  ar: {
    ...
    "hero.eyebrow": "مطبخ لبناني · إنسخيده", "hero.title": "تذوّق. شارك.<br /><em>وابقَ قليلاً.</em>", "hero.ritual": "نار · مائدة · لَمّة", "hero.copy": "لا رسمية ولا تكلّف؛ بل نار وموائد عامرة ونكهات نكتشفها معاً.", "hero.book": "اختر طاولتك", "hero.menu": "اكتشف القائمة", "hero.tonight": "هذا المساء في مَزَّة", "hero.available": "لا تزال هناك طاولات متاحة.", "hero.choose": "اختر بنفسك المكان الذي تحب الجلوس فيه.", "hero.start": "ابدأ الحجز", "hero.locationLabel": "في قلب إنسخيده", "hero.hoursLabel": "سبعة أيام في الأسبوع", "hero.arabicLabel": "تذوّق · شارك · ابقَ",
    "story.index": "01 · الحكاية", "story.title": "أمسية تبدأ<br /><em>بطبق صغير واحد.</em>", "story.photoCaption": "عالم دافئ في قلب إنسخيده.", "story.lead": "مَزَّة تعني أن تواصل التذوق والمشاركة والحديث. إنها الإجابة العربية على التاباس، بضيافة البيت.", "story.body": "مَزَّات باردة وساخنة، توابل عطرة وأطباق مشوية تصل إلى وسط المائدة. لا أحد يطلب لنفسه وحده.", "story.link": "اكتشف ما سيصل إلى المائدة", "story.quote": "«لا تكتمل المائدة حتى يشارك الجميع.»", "story.quoteBy": "— قاعدتنا المفضلة في البيت",
...
function translatePage(lang, persist = true) {
  ...
  const pageTitles = {
    ...
    ar: { home: "مَزَّة إنسخيده — ضيافة لبنانية", menu: "قائمة الطعام | مَزَّة إنسخيده", booking: "احجز طاولتك | مَزَّة إنسخيده", about: "عن مَزَّة | مطعم مَزَّة إنسخيده" }
  };
